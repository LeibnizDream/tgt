export const LANGUAGES = [
  ...
  "swedish", "italian", "indonesian", "hindi", "finnish", "vietnamese",
  ...
  "faroese", "haitiancreole", "pashto", "turkmen", "nynorsk", "maltese",
  "sanskrit", "luxembourgish", "myanmar", "tibetan", "tagalog", "malagasy",
